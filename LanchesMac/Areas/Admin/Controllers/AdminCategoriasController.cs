    ...
    public class AdminCategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var categoria = await _context.Categorias
                .FirstOrDefaultAsync(m => m.CateogriaId == id);
            if (categoria == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("CateogriaId,CategoriaNome,Descricao")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CateogriaId,CategoriaNome,Descricao")] Categoria categoria)
        {
            if (id != categoria.CateogriaId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!CategoriaExists(categoria.CateogriaId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return _context.Categorias.Any(e => e.CateogriaId == id);
        }
    }
}
